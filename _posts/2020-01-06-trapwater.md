...
```    
### 测试用例
[], [1,1,1],[1,0,0,0],[1,0,1,0]等

{: .box-note}
**Note:** 这里主要是他的细节做到好，对于两端的位置不可能储水。

参考[原文](https://leetcode-cn.com/problems/trapping-rain-water/solution/xiang-xi-tong-su-de-si-lu-fen-xi-duo-jie-fa-by-w-8/),他写的方法比较全面，无需赘述。